    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        xjClient.registerLocationListener(new XJLocationListener() {
            ...
            public void onReceiveLocation(XJLocation xjLocationLocation) {
                ...
                com.orhanobut.logger.Logger.e("dddd xjLocationLocation",xjLocationLocation.isInThisMap() + "" + xjLocationLocation.getNearLocationRegion());
                //定位位置是否在map中
                Toast.makeText(getApplicationContext(), xjLocationLocation.isInThisMap() + "" + xjLocationLocation.getNearLocationRegion(), Toast.LENGTH_SHORT).show();
